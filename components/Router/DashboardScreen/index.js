        ...
        <ScrollView>
            <View style={{
                ...
                <View style={styles.View}>
                    <Text style={{color: '#B9345E', fontSize: 25, fontWeight: 'bold'}}>De corona gegevens per gemeente</Text>
                    <Text style={{marginBottom: 10, fontSize: 16, fontWeight: 'bold', left: 0, textAlign: 'left'}}>Grafiek corona gegevens per gemeente.</Text>
                    <View style={{
                        borderTopWidth: 2,
                        paddingTop: 10,
